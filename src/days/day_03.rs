...
pub fn day_03() {
    ...
    for line in data_as_lines {
        ...
        let mut hash_set_second = std::collections::HashSet::new();
        hash_set_second.extend(second_half.chars());
        ...
        for char in common_char {
            ...
            let lower_case_char_as_u64 = (char.to_lowercase().next().unwrap() as u64) - 96;
            priorities += lower_case_char_as_u64;
        }
    }
