...
/// With everything replanted for next year (and with elephants and monkeys to tend the grove), you
/// and the Elves leave for the extraction point.
///
...
/// #.....#
/// #####.#
/// The walls of the valley are drawn as #; everything else is ground. Clear ground - where there is
/// currently no blizzard - is drawn as .. Otherwise, blizzards are drawn with an arrow indicating
/// their direction of motion: up (^), down (v), left (<), or right (>).
///
...
/// #.....#
/// #####.#
/// Finally, after yet another minute, the rightward-facing blizzard on the right is replaced with a
/// new one on the left facing the same direction:
///
/// #.#####
/// #.....#
/// #>....#
...
/// non-wall position in the bottom row. On each minute, you can move up, down, left, or right, or
/// you can wait in place. You and the blizzards act simultaneously, and you cannot share a position
/// with a blizzard.
///
...
pub fn day_24() {
    let _data = load_file(24);

    todo!("Sigh, yet another path finding thing")
}
