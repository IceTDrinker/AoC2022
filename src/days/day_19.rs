...
/// robots. Fortunately, there is an abundant amount of clay nearby that you can use to make them
/// waterproof.
///
/// In order to harvest the clay, you'll need special-purpose clay-collecting robots. To make any
/// type of robot, you'll need ore, which is also plentiful but in the opposite direction from the
/// clay.
///
...
/// configured it with a blueprint, you can't change it. You'll need to work out which blueprint is
/// best.
///
/// For example:
///
...
/// out which blueprint would maximize the number of opened geodes after 24 minutes by figuring out
/// which robots to build and when to build them.
///
/// Using blueprint 1 in the example above, the largest number of geodes you could open in 24
/// minutes is 9. One way to achieve that is:
///
/// == Minute 1 ==
...
/// produce in 24 minutes. What do you get if you add up the quality level of all of the blueprints
/// in your list?
pub fn day_19() {
    let _data = load_file(19);
